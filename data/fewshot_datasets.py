...
path_dict = {
    ...
    "flower102": ["jpg", "/root/autodl-tmp/dataset/data_splits/split_zhou_OxfordFlowers.json"],
    "food101": ["images", "/root/autodl-tmp/dataset/data_splits/split_zhou_Food101.json"],
    "dtd": ["images", "/root/autodl-tmp/dataset/data_splits/split_zhou_DescribableTextures.json"],
    "pets": ["images", "/root/autodl-tmp/dataset/data_splits/split_zhou_OxfordPets.json"],
    "sun397": ["SUN397", "/root/autodl-tmp/dataset/data_splits/split_zhou_SUN397.json"],
    "caltech101": ["101_ObjectCategories", "/root/autodl-tmp/dataset/data_splits/split_zhou_Caltech101.json"],
    "ucf101": ["UCF-101-midframes", "/root/autodl-tmp/dataset/data_splits/split_zhou_UCF101.json"],
    "cars": ["", "/root/autodl-tmp/dataset/data_splits/split_zhou_StanfordCars.json"],
    "eurosat": ["2750", "/root/autodl-tmp/dataset/data_splits/split_zhou_EuroSAT.json"]
}
